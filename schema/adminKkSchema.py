...
# Summary schema for list endpoints (exclude foto_kk)
class AdminKartuKeluargaSummarySchema(ma.Schema):
    id_kk = fields.Integer()
    no_kk = fields.Integer()
    nama_kepala_keluarga = fields.String()
    alamat = fields.String(allow_none=True)
...
admin_kk_summary_schema = AdminKartuKeluargaSummarySchema(many=False)
